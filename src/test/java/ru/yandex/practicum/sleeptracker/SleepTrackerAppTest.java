...
public class SleepTrackerAppTest {
    ...
    private SleepingSession session(int y, int m, int d, int hh, int mm, int endY, int endM, int endD, int endHh, int endMm, SleepQuality quality) {
        return new SleepingSession(LocalDateTime.of(y, m, d, hh, mm), LocalDateTime.of(endY, endM, endD, endHh, endMm), quality);
    }
    ...
    void totalSessionsMultiple() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 22, 0, 2025, 10, 2, 8, 0, SleepQuality.GOOD), session(2025, 10, 2, 23, 0, 2025, 10, 3, 7, 0, SleepQuality.NORMAL));
    ...
    void totalSessionsSingleSession() {
        TotalSessionsFunction f = new TotalSessionsFunction();
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 0, 2025, 10, 2, 5, 0, SleepQuality.BAD));
    ...
    void minDurationNormal() {
        ...
        // 600 мин и 360 мин
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 22, 0, 2025, 10, 2, 8, 0, SleepQuality.GOOD), // 600 min
    ...
    void minDurationSingleSession() {
        MinDurationFunction f = new MinDurationFunction();
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 0, 2025, 10, 2, 1, 0, SleepQuality.GOOD) // 120 min
        );
    ...
    void maxDurationSingleSession() {
        MaxDurationFunction f = new MaxDurationFunction();
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 0, 2025, 10, 2, 7, 0, SleepQuality.GOOD) // 480 min
        );
    ...
    void averageDurationSingleSession() {
        AverageDurationFunction f = new AverageDurationFunction();
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 0, 2025, 10, 2, 5, 0, SleepQuality.GOOD) // 360 min
        );
    ...
    void badQualitySessionsMixed() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 22, 0, 2025, 10, 2, 8, 0, SleepQuality.BAD), session(2025, 10, 2, 23, 0, 2025, 10, 3, 7, 0, SleepQuality.GOOD), session(2025, 10, 3, 22, 0, 2025, 10, 4, 6, 0, SleepQuality.BAD));
        assertEquals(2L, f.analyze(sessions).getValue());
    }
    ...
    void sleeplessNightsSingleNightCovered() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 0, 2025, 10, 2, 8, 0, SleepQuality.GOOD));
        assertEquals(0L, f.analyze(sessions).getValue());
    }
    ...
    void sleeplessNightsMissingNight() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 2, 22, 0, 2025, 10, 3, 7, 0, SleepQuality.GOOD), session(2025, 10, 4, 22, 0, 2025, 10, 5, 7, 0, SleepQuality.GOOD));
        assertEquals(1L, f.analyze(sessions).getValue());
    }
    ...
    void sleeplessNightsFirstSessionAfterNoon() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 13, 0, 2025, 10, 1, 14, 0, SleepQuality.NORMAL));
        assertEquals(0L, f.analyze(sessions).getValue());
    }
    ...
    void sleeplessNightsNoNightSleep() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 7, 0, 2025, 10, 1, 11, 0, SleepQuality.NORMAL));
        assertEquals(2L, f.analyze(sessions).getValue());
    }
    ...
    void sleeplessNightsBoundaryTimes() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 22, 0, 2025, 10, 2, 0, 0, SleepQuality.GOOD), // не перекрывает
        ...
        List<SleepingSession> sessions2 = List.of(session(2025, 10, 1, 22, 0, 2025, 10, 2, 0, 0, SleepQuality.GOOD) // end = 00:00, не > 00:00 => не покрывает
        );
    ...
    void sleeplessNightsMonthTransition() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 31, 22, 0, 2025, 11, 1, 7, 0, SleepQuality.GOOD), session(2025, 11, 2, 22, 0, 2025, 11, 3, 7, 0, SleepQuality.GOOD));
        assertEquals(1L, f.analyze(sessions).getValue());
    }
    ...
    void chronotypeOwl() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 30, 2025, 10, 2, 10, 0, SleepQuality.GOOD));
    ...
    void chronotypeOwlNightSession() {
        ChronotypeFunction f = new ChronotypeFunction();
        List<SleepingSession> sessions = List.of(new SleepingSession(LocalDateTime.of(2025, 10, 2, 1, 0),   // засыпание в 01:00
    ...
    void chronotypeLark() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 21, 30, 2025, 10, 2, 6, 30, SleepQuality.GOOD));
    ...
    void chronotypeDoveExactBoundaries() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 22, 0, 2025, 10, 2, 7, 0, SleepQuality.GOOD));
    ...
    void chronotypeMixedWithTie() {
        ...
        List<SleepingSession> sessions = List.of(session(2025, 10, 1, 23, 30, 2025, 10, 2, 10, 0, SleepQuality.GOOD), // OWL
